...
if ('C:\Users\Tyler\Documents\GitHub\INETGroup6\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\Tyler\Documents\GitHub\INETGroup6\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
